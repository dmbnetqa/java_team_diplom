...
- [Командный проект по курсу «Java для тестировщиков»](#командный-проект-по-курсу-java-для-тестировщиков)
  ...
  - [Инструкция к выполнению](#инструкция-к-выполнению)
    - [1 этап. Создание общего репозитория](#1-этап-создание-общего-репозитория)
    - [2 этап. Распределение задач](#2-этап-распределение-задач)
    - [3 этап. Поиск дефектов](#3-этап-поиск-дефектов)
    - [4 этап. Исправление дефектов и реализация методов](#4-этап-исправление-дефектов-и-реализация-методов)
    - [5 этап. Проверка на дефекты](#5-этап-проверка-на-дефекты)
